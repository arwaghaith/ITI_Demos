...
/************************************************Types***************************************************/
 ...
 {
    [Enable_Pin]    = {.Port   = GPIO_PORT_B, .Pin    = GPIO_PIN_0},
                     
    [ReadWrite_Pin] = {.Port   = GPIO_PORT_B, .Pin    = GPIO_PIN_1},

    [RegSelect_Pin] = {.Port   = GPIO_PORT_B, .Pin     = GPIO_PIN_2}
 };
 ...
 LCDPins_t const LCD_DataPins[_DataPins_num] =
 {
    ...
    [Data_Pin4] = {.Port   = GPIO_PORT_A, .Pin    = GPIO_PIN_4},

    [Data_Pin5] = {.Port   = GPIO_PORT_A, .Pin    = GPIO_PIN_5},

    [Data_Pin6] = {.Port   = GPIO_PORT_A, .Pin    = GPIO_PIN_6},
                     
    [Data_Pin7] = {.Port   = GPIO_PORT_A, .Pin    = GPIO_PIN_7}
