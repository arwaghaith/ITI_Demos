...
#define   	SYSTICK_u32SRC_CLK_MASK                (uint32_t)0x4
#define   	SYSTICK_u32ENABLE_MASK                 (uint32_t)0x1
#define     SYSTICK_u32TICKINT_MASK           (uint32_t)0x2
...
E_ErrorStatus_t Systick_SetTicTime_ms(uint32_t Systick_u32TimeMs);
E_ErrorStatus_t Systick_SetTicTime_Tick(uint32_t Systick_u32setTick);
